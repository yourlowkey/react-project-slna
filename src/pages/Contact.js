                ...
                <div className="col-md-8 col-12 mx-auto">
                    <div className="card shadow-lg border-0 p-4">
                        ...
                        <div className="form-group mb-5">
                            <div className="row">
                                <div className="col-md-6 col-12 mx-auto my-2">
                                    <input type="text" className="form-control-lg" placeholder="Địa chỉ Facebook" required />
                                </div>
                                <div className="col-md-6 col-12 mx-auto my-2">
                                    <input type="text" className="form-control-lg" placeholder="Địa chỉ nhà riêng" required />
                                </div>
                            </div>
                        </div>
                        <div className="row">
                            <div className="col-13">
                                <textarea class="form-control" id="description" placeholder="Nhập nội dung vào đây!" rows="350px" height="350px"></textarea>
                            </div>
                        </div>
                        <div className="mt-5 col-md-6 col-12 mx-auto">
                            <button className="btn btn-outline-dark btn-lg btn-block" type="submit">Gửi thông tin</button>
                        </div>
                    </div>
                </div>
            </div>
